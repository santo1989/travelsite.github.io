<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PackageView.aspx.cs" Inherits="PackageView" MasterPageFile="~/MasterPage.master" %>
                ...
                <table border="1" class="auto-style1">
                    ...
                    <tr>
                        <td class="auto-style2">
                            ...
                            <br />
                            <asp:ImageButton ID="ImageButton1" runat="server" Height="133px" ImageUrl="~/Package/book now.png" Width="238px" OnClick="ImageButton1_Click" />
                        </td>
                    </tr>
                </table>
                <br />
